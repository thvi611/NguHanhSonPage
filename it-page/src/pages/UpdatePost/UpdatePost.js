...
export default function UpdatePost() {
    ...
    const handleClick = async (e) => {
        ...
        try {
            const resp = await axios.post(`https://88f6-1-53-200-28.ap.ngrok.io/api/${type}/${id}`, formData);
    ...
    const renderImage = () => {
        return(
            <img src={"https://88f6-1-53-200-28.ap.ngrok.io/storage" + image.url} alt='' style={{height: "50%",width: "50%",objectFit:"contain"}} className="m-0"/>
        );
    }
